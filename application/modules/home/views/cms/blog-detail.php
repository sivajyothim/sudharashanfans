					...
					<div class="p-r-50 p-r-0-lg">
						<div class="p-b-40">
							<div class="blog-detail-img wrap-pic-w">
								<img src="<?php echo FRONT_IMAGES_PATH;?>/blog-04.jpg" alt="IMG-BLOG">
							</div>
						...
						<ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="product-detail.php" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo FRONT_IMAGES_PATH;?>/item-16.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.php" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo FRONT_IMAGES_PATH;?>/item-17.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.php" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo FRONT_IMAGES_PATH;?>/item-08.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.php" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo FRONT_IMAGES_PATH;?>/item-03.jpg" alt="IMG-PRODUCT">
								</a>
							...
							<li class="flex-w p-b-20">
								<a href="product-detail.php" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="<?php echo FRONT_IMAGES_PATH;?>/item-05.jpg" alt="IMG-PRODUCT">
								</a>

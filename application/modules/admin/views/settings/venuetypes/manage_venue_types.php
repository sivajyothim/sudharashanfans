                                        ...
                                        <div class="col-lg-6 text-center" style="padding:0rem">
                                            <div class="table-responsive" style="line-height:0.5">
                                                <table id="datatable" class="table v-middle p-0 m-0 box" data-plugin="dataTable">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $data_req = json_decode($venuetype_details);
                                                        if ($data_req->code == SUCCESS_CODE):
                                                            $sno = 1;
                                                            foreach ($data_req->venue_type_result as $data_res):
                                                                $unique_id= $data_res->venuetype_unique_id;
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo $sno; ?>
                                                                    <input type="checkbox">
                                                                    </td>
                                                                    <td><?php echo fetch_ucfirst($data_res->venuetype_title); ?></td>
                                                                    <td><?php echo strtoupper($data_res->venuetype_code); ?></td>
      ...
      */
        ...
        if (str == true)
        {
            ...
            $.ajax({
                ...
                url: "<?php echo ADMIN_LINK; ?>Settings/insertVenueType",
                contentType: false,
                cache: false,
                processData: false,
                success: function (s) {

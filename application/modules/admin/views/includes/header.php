    ...
    <div class="content-header white  box-shadow-1" id="content-header">
        <div class="navbar navbar-expand-lg">
            ...
            <div class="navbar-text nav-title flex" id="pageTitle">
                <img src="<?php echo ADMIN_LOGO; ?>" width="100%"/>
            </div>

            <ul class="nav flex-row order-lg-2">
                <!-- Notification list module code start -->
                ...
                <!-- Notification list module code end -->
                <!-- User dropdown menu -->
                <li class="dropdown d-flex align-items-center">
                    <a href="#" data-toggle="dropdown" class="d-flex align-items-center">
                        <span class="avatar w-32">
                            <img src="<?php echo ADMIN_IMAGES_PATH; ?>k.jpg" alt="...">
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right w pt-0 mt-2 animate fadeIn">
                        <div class="row no-gutters b-b mb-2">
                            <div class="col-6 b-r">
                                <a onclick="return confirm('Confirm to logout..??')" href="<?php echo ADMIN_LINK; ?>logout" class="py-2 pt-3 d-block text-center">
                                    <i class="fa text-md fa-power-off"></i>
                                    <small class="d-block">Log out</small>
                                </a>
                            </div>
                            <!--                            <div class="col-4 b-r">
                            ...
                            <div class="col-6">
                                <a href="javscript:void(0)" class="py-2 pt-3 d-block text-center">
                                    <i class="fa text-md fa-user text-muted"></i>
                        ...
                        <a onclick="return confirm('Confirm to logout..??')" class="dropdown-item" href="<?php echo ADMIN_LINK . 'logout'; ?>">
            ...
            <div class="collapse navbar-collapse  order-lg-1" id="navbarToggler">
                <?php $this->load->view('header_navigation'); ?>
            </div>
        </div>
    </div>
